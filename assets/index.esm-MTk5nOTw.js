 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(et(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function et(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const A="@firebase/app",P="0.15.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vt(t){F(new S("platform-logger",e=>new Ze(e),"PRIVATE")),F(new S("heartbeat",e=>new Ht(e),"PRIVATE")),D(A,P,t),D(A,P,"esm2020"),D("fire-js","")}Vt("");export{ve as A,Se as B,S as C,De as D,ie as E,w as F,Zt as G,en as H,O as I,K as J,hn as K,Fe as L,m as M,un as N,E as O,he as P,Tt as Q,v as R,pn as S,$t as T,bn as U,Nt as V,gn as W,yn as X,vn as Y,dn as _,nn as a,Bt as b,Gt as c,L as d,sn as e,Ce as f,an as g,mn as h,cn as i,ne as j,Qt as k,tn as l,te as m,l as n,Kt as o,ln as p,rn as q,Xt as r,qt as s,Yt as t,F as u,D as v,on as w,Jt as x,jt as y,fn as z};
