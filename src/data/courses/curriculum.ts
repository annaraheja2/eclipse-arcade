...
export const PLACEMENT: Record<string, Record<string, string>> = {
  'algebra-1': {
    ...
    'evaluating-polynomials': 'polynomials#Adding & Subtracting Polynomials',
  ...
  geometry: {
    ...
    'corresponding-parts': 'congruence#CPCTC',
    ...
    'surface-area-and-volume': 'area-and-volume#Volume of Solids',
  ...
  'algebra-2': {
    ...
    'statistics-and-distributions': 'probability-and-statistics#Normal Distribution (Intro)',
  },
  precalculus: {
    ...
    'log-laws': 'exponential-and-logarithmic-functions#Logarithmic Scales & Applications',
    ...
    'amplitude-and-period': 'trigonometric-functions#Unit Circle Mastery',
    ...
    'polar-coordinates': 'trigonometric-functions#Polar Coordinates & Graphs',
    'parametric-curves': 'trigonometric-functions#Parametric Equations',
    ...
    'continuity-and-derivatives': 'limits-and-intro-to-calculus#Continuity',
    'sigma-notation': 'sequences-series-and-sigma-notation#Series & Tests (Intro)',
