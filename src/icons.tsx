...
export const Ladder = (p: SVGProps<SVGSVGElement>) => (<svg {...s(p)}><path d="M8.5 21V3M15.5 21V3M8.5 7.5h7M8.5 12h7M8.5 16.5h7" /></svg>)
...
export const Crown = (p: SVGProps<SVGSVGElement>) => (<svg {...s(p)}><path d="M4.5 18.5h15M4.5 18.5 3 7.5l4.8 3.7L12 4.5l4.2 6.7L21 7.5l-1.5 11" /></svg>)
export const Book = (p: SVGProps<SVGSVGElement>) => (<svg {...s(p)}><path d="M4 4.8A1.8 1.8 0 0 1 5.8 3H19v14H6a2 2 0 0 0-2 2zM4 18.8A2.2 2.2 0 0 0 6.2 21H19M8 7.5h7M8 11h5" /></svg>)
