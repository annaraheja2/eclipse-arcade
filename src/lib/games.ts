...
export const GAMES: GameDef[] = [
  ...
  { key: 'pinpoint', name: 'PinPoint', color: '#3df5ff', type: 'pin', rounds: PINPOINT_ROUNDS },
  ...
  { key: 'fitline', name: 'Fit-the-Line', color: '#a24bff', type: 'soon', rounds: [] },
]
